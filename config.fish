...
# DBT
source $HOME/.venv/dbt/bin/activate.fish
set -x DBT_ENV_SECRET_GIT_CREDENTIAL "$(op item get "DBT Dev Environment Git Credential" --vault "Employee" --format json --fields password | jq .value --raw-output)"
set -x DEV_SCHEMA_NAME "skylarpape"
